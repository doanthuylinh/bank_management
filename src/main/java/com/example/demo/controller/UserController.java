...
public class UserController {
    ...
    public ResponseEntity<ResultBean> updateProduct(@RequestBody UserEntity entity, @PathVariable Integer id) {
        try {
            entity.setUserId(id);
    ...
    public ResponseEntity<ResultBean> login(@RequestBody String entity) {
        ...
        return new ResponseEntity<ResultBean>(new ResultBean("200", MessageUtils.getMessage("MSG03")), HttpStatus.OK);
    }
